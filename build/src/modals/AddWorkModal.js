...
import newworkflow from '../api/newworkflow';
...
class AddWorkModal extends Component {
  ...
  handleOk = (e) => {
    ...
    this.props.dispatch(addWork(newworkflow.data));//TODO
  }
...
const mapStateToProps = state => {
  const { menusReducer: { contextInfo, contextOperate, contextButton } } = state;
